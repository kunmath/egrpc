...
class Point final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:routeguide.Point) */ {
 public:
...
class Rectangle final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:routeguide.Rectangle) */ {
 public:
...
class Feature final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:routeguide.Feature) */ {
 public:
...
class RouteNote final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:routeguide.RouteNote) */ {
 public:
...
class RouteSummary final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:routeguide.RouteSummary) */ {
 public:
